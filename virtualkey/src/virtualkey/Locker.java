...
public class Locker {
	...
	public static void main(String[] args) {
		...
		System.out.println("---------------------------------------");
		System.out.println("Name        : M.Surya teja");
		System.out.println("Email       : suryateja@company.com");
		...
		lp : while(true)
		{
			...
			case 1: File file = new File("C:\\Users\\SURYA TEJA\\eclipse-workspace\\updates");
					...
					ip : while(true)
					{
						...
						case 1 : System.out.println("\n---------------------------------------");
								 ...
								 try
								 {
									 ...
									 File fe = new File("C:\\Users\\SURYA TEJA\\eclipse-workspace\\updates"+name);
									 if(fe.exists())
									 {
									 ...
									 {
										 FileWriter fw = new FileWriter("C:\\Users\\SURYA TEJA\\eclipse-workspace\\updates\\"+name);
						...
						case 2 : System.out.println("\n---------------------------------------");
								 ...
								 File fd = new File("C:\\Users\\SURYA TEJA\\eclipse-workspace\\updates\\"+deletename);
								 if(fd.exists())
								 {
									 if(fd.delete())
								        {
						...
						case 3 : System.out.println("\n---------------------------------------");
								 ...
								 try
								 {
									 File filesearch = new File("C:\\Users\\SURYA TEJA\\eclipse-workspace\\updates");
